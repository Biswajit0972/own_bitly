...
export const clicksOnShortUrlsSchema = t.pgTable(
    "clicks_on_short_urls",
    {
        id: t.integer("id").primaryKey().generatedByDefaultAsIdentity(),

        click_time: t.timestamp("click_time").defaultNow().notNull(),

        short_code: t
            .varchar("short_code", { length: 155 })
            .references(() => shortUrlSchema.shortCode, { onDelete: "cascade" })
            .notNull(),
